...
<div id="main">
    ...
    <div class="col-md-4 col-md-offset-4">
        <div class="login">
            ...
            <a href="{{ URL::to('/') }}"><img src="{{ URL::asset('upload/'.getcong('site_logo')) }}" style="width: 100%" alt="logo"></a>
            </div>
               ...
               <!-- <div class="avatar">
				...
				<span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-warning">Sign in <i class="md md-lock-open"></i></button>
                    </div>
                {!! Form::close() !!}
            </div>
