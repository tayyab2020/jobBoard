                ...
                <div class="btn-group">
								...
								<ul class="dropdown-menu dropdown-menu-right" role="menu">
									...
									<li>
					                	...
					                	<a href="{{ url('admin/news/featurednews/'.$news->id) }}"><i class="fa fa-heart"></i> Set as Urgent</a>
					                	 @else
					                	 <a href="{{ url('admin/news/featurednews/'.$news->id) }}"><i class="fa fa-heart-o"></i> Unset as Urgent</a>
					                	@endif
									</li>
									@endif
